...
I keep this simple, for the same reasons I described in my <a href="/blog/three-fund-portfolio-explained" class="text-forest-600 underline hover:text-forest-700">three-fund portfolio explainer</a>.
...
If you want more detail on why I don't pick individual stocks or try to time allocations, I covered that reasoning in <a href="/blog/why-i-dont-pick-stocks-anymore" class="text-forest-600 underline hover:text-forest-700">this piece on why I stopped picking stocks</a>.
