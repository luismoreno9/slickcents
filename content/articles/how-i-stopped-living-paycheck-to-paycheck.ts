...
const article: Article = {
  ...
  image: "/images/articles/wallet-control.jpg",
  readTime: "8 min read",
  body: `
...
The <a href="/blog/zero-based-budget-finally-worked" class="text-forest-600 underline hover:text-forest-700">zero-based budgeting method</a> I tried later helped me go further. But the first move — the one that actually broke the cycle — was this structural change. Move the money before you can spend it, into an account you can't see easily, and let your lifestyle quietly adjust to the smaller number.

After I had three months of breathing room, I also started tracking where every dollar went. I wrote about that process in <a href="/blog/where-my-money-actually-goes" class="text-forest-600 underline hover:text-forest-700">this piece on where my money actually goes</a>, and it reinforced everything the automatic transfer had already started.
